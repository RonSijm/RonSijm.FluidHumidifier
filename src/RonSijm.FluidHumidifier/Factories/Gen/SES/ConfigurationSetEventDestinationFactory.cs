...
public class ConfigurationSetEventDestinationFactory(string resourceName = null, Action<Humidifier.SES.ConfigurationSetEventDestination> factoryAction = null) : ResourceFactory<Humidifier.SES.ConfigurationSetEventDestination>(resourceName)
{

    internal InnerConfigurationSetEventDestinationEventDestinationFactory EventDestinationFactory { get; set; }

    protected override Humidifier.SES.ConfigurationSetEventDestination Create()
    {
    ...
    private Humidifier.SES.ConfigurationSetEventDestination CreateConfigurationSetEventDestination()
    {
        var configurationSetEventDestinationResult = new Humidifier.SES.ConfigurationSetEventDestination
        {
    ...
    public override void CreateChildren(Humidifier.SES.ConfigurationSetEventDestination result)
    {
...
{
    public static CombinedResult<ConfigurationSetEventDestinationFactory, InnerConfigurationSetEventDestinationEventDestinationFactory> WithEventDestination(this ConfigurationSetEventDestinationFactory parentFactory, Action<Humidifier.SES.ConfigurationSetEventDestinationTypes.EventDestination> subFactoryAction = null)
    {
