...
public class InnerByteMatchSetByteMatchTupleFactory(Action<Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple> factoryAction = null) : SubResourceFactory<Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple>
{

    internal InnerByteMatchSetFieldToMatchFactory FieldToMatchFactory { get; set; }

    protected override Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple Create()
    {
    ...
    private Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple CreateByteMatchTuple()
    {
        var byteMatchTupleResult = new Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple();

        return byteMatchTupleResult;
    }
    public override void CreateChildren(Humidifier.WAFRegional.ByteMatchSetTypes.ByteMatchTuple result)
    {
...
{
    public static CombinedResult<InnerByteMatchSetByteMatchTupleFactory, InnerByteMatchSetFieldToMatchFactory> WithFieldToMatch(this InnerByteMatchSetByteMatchTupleFactory parentFactory, Action<Humidifier.WAFRegional.ByteMatchSetTypes.FieldToMatch> subFactoryAction = null)
    {
    ...
    public static CombinedResult<T1, InnerByteMatchSetByteMatchTupleFactory, InnerByteMatchSetFieldToMatchFactory> WithFieldToMatch<T1>(this CombinedResult<T1, InnerByteMatchSetByteMatchTupleFactory> combinedResult, Action<Humidifier.WAFRegional.ByteMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, WithFieldToMatch(combinedResult.T2, subFactoryAction));
    ...
    public static CombinedResult<T1, InnerByteMatchSetByteMatchTupleFactory, T2, T3, T4, InnerByteMatchSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, InnerByteMatchSetByteMatchTupleFactory, T2, T3, T4> combinedResult, Action<Humidifier.WAFRegional.ByteMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T2, subFactoryAction));
