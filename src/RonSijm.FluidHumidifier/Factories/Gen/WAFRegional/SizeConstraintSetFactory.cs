...
public class SizeConstraintSetFactory(string resourceName = null, Action<Humidifier.WAFRegional.SizeConstraintSet> factoryAction = null) : ResourceFactory<Humidifier.WAFRegional.SizeConstraintSet>(resourceName)
{

    internal List<InnerSizeConstraintSetSizeConstraintFactory> SizeConstraintsFactories { get; set; } = [];

    protected override Humidifier.WAFRegional.SizeConstraintSet Create()
    {
    ...
    private Humidifier.WAFRegional.SizeConstraintSet CreateSizeConstraintSet()
    {
        var sizeConstraintSetResult = new Humidifier.WAFRegional.SizeConstraintSet
        {
    ...
    public override void CreateChildren(Humidifier.WAFRegional.SizeConstraintSet result)
    {
...
{
    public static CombinedResult<SizeConstraintSetFactory, InnerSizeConstraintSetSizeConstraintFactory> WithSizeConstraints(this SizeConstraintSetFactory parentFactory, Action<Humidifier.WAFRegional.SizeConstraintSetTypes.SizeConstraint> subFactoryAction = null)
    {
