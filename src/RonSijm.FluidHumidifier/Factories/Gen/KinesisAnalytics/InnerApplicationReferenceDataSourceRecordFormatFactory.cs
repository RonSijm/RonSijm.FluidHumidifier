...
public class InnerApplicationReferenceDataSourceRecordFormatFactory(Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat> factoryAction = null) : SubResourceFactory<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat>
{

    internal InnerApplicationReferenceDataSourceMappingParametersFactory MappingParametersFactory { get; set; }

    protected override Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat Create()
    {
    ...
    private Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat CreateRecordFormat()
    {
        var recordFormatResult = new Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat();

        return recordFormatResult;
    }
    public override void CreateChildren(Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.RecordFormat result)
    {
...
{
    public static CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters(this InnerApplicationReferenceDataSourceRecordFormatFactory parentFactory, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null)
    {
    ...
    public static CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters<T1>(this CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1> combinedResult, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null) => new (combinedResult, combinedResult, WithMappingParameters(combinedResult.T1, subFactoryAction));
    ...
    public static CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters<T1, T2>(this CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2> combinedResult, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithMappingParameters(combinedResult.T1, subFactoryAction));
    ...
    public static CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2, T3, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters<T1, T2, T3>(this CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2, T3> combinedResult, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithMappingParameters(combinedResult.T1, subFactoryAction));
    ...
    public static CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2, T3, T4, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters<T1, T2, T3, T4>(this CombinedResult<InnerApplicationReferenceDataSourceRecordFormatFactory, T1, T2, T3, T4> combinedResult, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithMappingParameters(combinedResult.T1, subFactoryAction));
    ...
    public static CombinedResult<T1, T2, T3, T4, InnerApplicationReferenceDataSourceRecordFormatFactory, InnerApplicationReferenceDataSourceMappingParametersFactory> WithMappingParameters<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, T4, InnerApplicationReferenceDataSourceRecordFormatFactory> combinedResult, Action<Humidifier.KinesisAnalytics.ApplicationReferenceDataSourceTypes.MappingParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithMappingParameters(combinedResult.T5, subFactoryAction));
}
