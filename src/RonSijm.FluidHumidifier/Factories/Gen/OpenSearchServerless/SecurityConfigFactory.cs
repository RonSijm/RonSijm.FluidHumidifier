...
public class SecurityConfigFactory(string resourceName = null, Action<Humidifier.OpenSearchServerless.SecurityConfig> factoryAction = null) : ResourceFactory<Humidifier.OpenSearchServerless.SecurityConfig>(resourceName)
{
    ...
    internal InnerSecurityConfigIamIdentityCenterConfigOptionsFactory IamIdentityCenterOptionsFactory { get; set; }
...
public static class SecurityConfigFactoryExtensions
{
    ...
    public static CombinedResult<SecurityConfigFactory, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions(this SecurityConfigFactory parentFactory, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null)
    {
        parentFactory.IamIdentityCenterOptionsFactory = new InnerSecurityConfigIamIdentityCenterConfigOptionsFactory(subFactoryAction);
    ...
    public static CombinedResult<SecurityConfigFactory, T1, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1>(this CombinedResult<SecurityConfigFactory, T1> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, SecurityConfigFactory, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1>(this CombinedResult<T1, SecurityConfigFactory> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T2, subFactoryAction));
    public static CombinedResult<SecurityConfigFactory, T1, T2, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2>(this CombinedResult<SecurityConfigFactory, T1, T2> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, SecurityConfigFactory, T2, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2>(this CombinedResult<T1, SecurityConfigFactory, T2> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, SecurityConfigFactory, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2>(this CombinedResult<T1, T2, SecurityConfigFactory> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T3, subFactoryAction));
    public static CombinedResult<SecurityConfigFactory, T1, T2, T3, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3>(this CombinedResult<SecurityConfigFactory, T1, T2, T3> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, SecurityConfigFactory, T2, T3, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3>(this CombinedResult<T1, SecurityConfigFactory, T2, T3> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, SecurityConfigFactory, T3, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3>(this CombinedResult<T1, T2, SecurityConfigFactory, T3> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, SecurityConfigFactory, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3>(this CombinedResult<T1, T2, T3, SecurityConfigFactory> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T4, subFactoryAction));
    public static CombinedResult<SecurityConfigFactory, T1, T2, T3, T4, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3, T4>(this CombinedResult<SecurityConfigFactory, T1, T2, T3, T4> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, SecurityConfigFactory, T2, T3, T4, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3, T4>(this CombinedResult<T1, SecurityConfigFactory, T2, T3, T4> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, SecurityConfigFactory, T3, T4, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3, T4>(this CombinedResult<T1, T2, SecurityConfigFactory, T3, T4> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, SecurityConfigFactory, T4, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, SecurityConfigFactory, T4> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T4, subFactoryAction));
    public static CombinedResult<T1, T2, T3, T4, SecurityConfigFactory, InnerSecurityConfigIamIdentityCenterConfigOptionsFactory> WithIamIdentityCenterOptions<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, T4, SecurityConfigFactory> combinedResult, Action<Humidifier.OpenSearchServerless.SecurityConfigTypes.IamIdentityCenterConfigOptions> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithIamIdentityCenterOptions(combinedResult.T5, subFactoryAction));
}
