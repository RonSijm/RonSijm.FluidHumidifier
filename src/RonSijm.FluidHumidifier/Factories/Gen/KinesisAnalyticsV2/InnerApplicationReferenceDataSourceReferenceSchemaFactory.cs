...
public class InnerApplicationReferenceDataSourceReferenceSchemaFactory(Action<Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema> factoryAction = null) : SubResourceFactory<Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema>
{

    internal InnerApplicationReferenceDataSourceRecordFormatFactory RecordFormatFactory { get; set; }

    protected override Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema Create()
    {
    ...
    private Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema CreateReferenceSchema()
    {
        var referenceSchemaResult = new Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema();

        return referenceSchemaResult;
    }
    public override void CreateChildren(Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.ReferenceSchema result)
    {
...
{
    public static CombinedResult<InnerApplicationReferenceDataSourceReferenceSchemaFactory, InnerApplicationReferenceDataSourceRecordFormatFactory> WithRecordFormat(this InnerApplicationReferenceDataSourceReferenceSchemaFactory parentFactory, Action<Humidifier.KinesisAnalyticsV2.ApplicationReferenceDataSourceTypes.RecordFormat> subFactoryAction = null)
    {
