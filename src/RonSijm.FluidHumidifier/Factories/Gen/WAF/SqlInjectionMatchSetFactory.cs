...
public class SqlInjectionMatchSetFactory(string resourceName = null, Action<Humidifier.WAF.SqlInjectionMatchSet> factoryAction = null) : ResourceFactory<Humidifier.WAF.SqlInjectionMatchSet>(resourceName)
{

    internal List<InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory> SqlInjectionMatchTuplesFactories { get; set; } = [];

    protected override Humidifier.WAF.SqlInjectionMatchSet Create()
    {
    ...
    private Humidifier.WAF.SqlInjectionMatchSet CreateSqlInjectionMatchSet()
    {
        var sqlInjectionMatchSetResult = new Humidifier.WAF.SqlInjectionMatchSet
        {
    ...
    public override void CreateChildren(Humidifier.WAF.SqlInjectionMatchSet result)
    {
...
{
    public static CombinedResult<SqlInjectionMatchSetFactory, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory> WithSqlInjectionMatchTuples(this SqlInjectionMatchSetFactory parentFactory, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple> subFactoryAction = null)
    {
