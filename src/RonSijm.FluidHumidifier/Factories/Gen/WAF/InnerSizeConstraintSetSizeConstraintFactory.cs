...
public class InnerSizeConstraintSetSizeConstraintFactory(Action<Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint> factoryAction = null) : SubResourceFactory<Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint>
{

    internal InnerSizeConstraintSetFieldToMatchFactory FieldToMatchFactory { get; set; }

    protected override Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint Create()
    {
    ...
    private Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint CreateSizeConstraint()
    {
        var sizeConstraintResult = new Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint();

        return sizeConstraintResult;
    }
    public override void CreateChildren(Humidifier.WAF.SizeConstraintSetTypes.SizeConstraint result)
    {
...
{
    public static CombinedResult<InnerSizeConstraintSetSizeConstraintFactory, InnerSizeConstraintSetFieldToMatchFactory> WithFieldToMatch(this InnerSizeConstraintSetSizeConstraintFactory parentFactory, Action<Humidifier.WAF.SizeConstraintSetTypes.FieldToMatch> subFactoryAction = null)
    {
    ...
    public static CombinedResult<InnerSizeConstraintSetSizeConstraintFactory, T1, T2, T3, T4, InnerSizeConstraintSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<InnerSizeConstraintSetSizeConstraintFactory, T1, T2, T3, T4> combinedResult, Action<Humidifier.WAF.SizeConstraintSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, InnerSizeConstraintSetSizeConstraintFactory, T2, T3, T4, InnerSizeConstraintSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, InnerSizeConstraintSetSizeConstraintFactory, T2, T3, T4> combinedResult, Action<Humidifier.WAF.SizeConstraintSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, InnerSizeConstraintSetSizeConstraintFactory, T3, T4, InnerSizeConstraintSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, T2, InnerSizeConstraintSetSizeConstraintFactory, T3, T4> combinedResult, Action<Humidifier.WAF.SizeConstraintSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T3, subFactoryAction));
