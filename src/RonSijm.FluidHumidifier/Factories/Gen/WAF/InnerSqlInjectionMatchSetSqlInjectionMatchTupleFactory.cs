...
public class InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory(Action<Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple> factoryAction = null) : SubResourceFactory<Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple>
{

    internal InnerSqlInjectionMatchSetFieldToMatchFactory FieldToMatchFactory { get; set; }

    protected override Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple Create()
    {
    ...
    private Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple CreateSqlInjectionMatchTuple()
    {
        var sqlInjectionMatchTupleResult = new Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple();

        return sqlInjectionMatchTupleResult;
    }
    public override void CreateChildren(Humidifier.WAF.SqlInjectionMatchSetTypes.SqlInjectionMatchTuple result)
    {
...
{
    public static CombinedResult<InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, InnerSqlInjectionMatchSetFieldToMatchFactory> WithFieldToMatch(this InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory parentFactory, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.FieldToMatch> subFactoryAction = null)
    {
    ...
    public static CombinedResult<T1, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, InnerSqlInjectionMatchSetFieldToMatchFactory> WithFieldToMatch<T1>(this CombinedResult<T1, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory> combinedResult, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, WithFieldToMatch(combinedResult.T2, subFactoryAction));
    ...
    public static CombinedResult<T1, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T2, T3, T4, InnerSqlInjectionMatchSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T2, T3, T4> combinedResult, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T3, T4, InnerSqlInjectionMatchSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, T2, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T3, T4> combinedResult, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T4, InnerSqlInjectionMatchSetFieldToMatchFactory> WithFieldToMatch<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, InnerSqlInjectionMatchSetSqlInjectionMatchTupleFactory, T4> combinedResult, Action<Humidifier.WAF.SqlInjectionMatchSetTypes.FieldToMatch> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithFieldToMatch(combinedResult.T4, subFactoryAction));
