...
public class ByteMatchSetFactory(string resourceName = null, Action<Humidifier.WAF.ByteMatchSet> factoryAction = null) : ResourceFactory<Humidifier.WAF.ByteMatchSet>(resourceName)
{

    internal List<InnerByteMatchSetByteMatchTupleFactory> ByteMatchTuplesFactories { get; set; } = [];

    protected override Humidifier.WAF.ByteMatchSet Create()
    {
    ...
    private Humidifier.WAF.ByteMatchSet CreateByteMatchSet()
    {
        var byteMatchSetResult = new Humidifier.WAF.ByteMatchSet
        {
    ...
    public override void CreateChildren(Humidifier.WAF.ByteMatchSet result)
    {
...
{
    public static CombinedResult<ByteMatchSetFactory, InnerByteMatchSetByteMatchTupleFactory> WithByteMatchTuples(this ByteMatchSetFactory parentFactory, Action<Humidifier.WAF.ByteMatchSetTypes.ByteMatchTuple> subFactoryAction = null)
    {
