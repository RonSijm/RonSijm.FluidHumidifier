...
public class ConnectionFactory(string resourceName = null, Action<Humidifier.Events.Connection> factoryAction = null) : ResourceFactory<Humidifier.Events.Connection>(resourceName)
{
    ...
    internal InnerConnectionInvocationConnectivityParametersFactory InvocationConnectivityParametersFactory { get; set; }
    ...
    public override void CreateChildren(Humidifier.Events.Connection result)
    {
        ...
        result.InvocationConnectivityParameters ??= InvocationConnectivityParametersFactory?.Build();
    }
...
public static class ConnectionFactoryExtensions
{
    ...
    public static CombinedResult<ConnectionFactory, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters(this ConnectionFactory parentFactory, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null)
    {
        parentFactory.InvocationConnectivityParametersFactory = new InnerConnectionInvocationConnectivityParametersFactory(subFactoryAction);
        return CombinedResultFactory.Create(parentFactory, parentFactory.InvocationConnectivityParametersFactory);
    }
    ...
    public static CombinedResult<ConnectionFactory, T1, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1>(this CombinedResult<ConnectionFactory, T1> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, ConnectionFactory, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1>(this CombinedResult<T1, ConnectionFactory> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T2, subFactoryAction));
    public static CombinedResult<ConnectionFactory, T1, T2, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2>(this CombinedResult<ConnectionFactory, T1, T2> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, ConnectionFactory, T2, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2>(this CombinedResult<T1, ConnectionFactory, T2> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, ConnectionFactory, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2>(this CombinedResult<T1, T2, ConnectionFactory> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T3, subFactoryAction));
    public static CombinedResult<ConnectionFactory, T1, T2, T3, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3>(this CombinedResult<ConnectionFactory, T1, T2, T3> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, ConnectionFactory, T2, T3, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3>(this CombinedResult<T1, ConnectionFactory, T2, T3> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, ConnectionFactory, T3, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3>(this CombinedResult<T1, T2, ConnectionFactory, T3> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, ConnectionFactory, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3>(this CombinedResult<T1, T2, T3, ConnectionFactory> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T4, subFactoryAction));
    public static CombinedResult<ConnectionFactory, T1, T2, T3, T4, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3, T4>(this CombinedResult<ConnectionFactory, T1, T2, T3, T4> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, ConnectionFactory, T2, T3, T4, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3, T4>(this CombinedResult<T1, ConnectionFactory, T2, T3, T4> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, ConnectionFactory, T3, T4, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3, T4>(this CombinedResult<T1, T2, ConnectionFactory, T3, T4> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, ConnectionFactory, T4, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, ConnectionFactory, T4> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T4, subFactoryAction));
    public static CombinedResult<T1, T2, T3, T4, ConnectionFactory, InnerConnectionInvocationConnectivityParametersFactory> WithInvocationConnectivityParameters<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, T4, ConnectionFactory> combinedResult, Action<Humidifier.Events.ConnectionTypes.InvocationConnectivityParameters> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithInvocationConnectivityParameters(combinedResult.T5, subFactoryAction));
}
