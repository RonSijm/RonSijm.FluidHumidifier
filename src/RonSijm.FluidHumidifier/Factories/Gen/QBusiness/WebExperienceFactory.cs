...
public class WebExperienceFactory(string resourceName = null, Action<Humidifier.QBusiness.WebExperience> factoryAction = null) : ResourceFactory<Humidifier.QBusiness.WebExperience>(resourceName)
{
    ...
    internal InnerWebExperienceCustomizationConfigurationFactory CustomizationConfigurationFactory { get; set; }
    ...
    public override void CreateChildren(Humidifier.QBusiness.WebExperience result)
    {
        ...
        result.CustomizationConfiguration ??= CustomizationConfigurationFactory?.Build();
...
{
    public static CombinedResult<WebExperienceFactory, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration(this WebExperienceFactory parentFactory, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null)
    {
        parentFactory.CustomizationConfigurationFactory = new InnerWebExperienceCustomizationConfigurationFactory(subFactoryAction);
        return CombinedResultFactory.Create(parentFactory, parentFactory.CustomizationConfigurationFactory);
    }
    ...
    public static CombinedResult<WebExperienceFactory, T1, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1>(this CombinedResult<WebExperienceFactory, T1> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, WebExperienceFactory, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1>(this CombinedResult<T1, WebExperienceFactory> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T2, subFactoryAction));
    public static CombinedResult<WebExperienceFactory, T1, T2, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2>(this CombinedResult<WebExperienceFactory, T1, T2> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, WebExperienceFactory, T2, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2>(this CombinedResult<T1, WebExperienceFactory, T2> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, WebExperienceFactory, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2>(this CombinedResult<T1, T2, WebExperienceFactory> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T3, subFactoryAction));
    public static CombinedResult<WebExperienceFactory, T1, T2, T3, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3>(this CombinedResult<WebExperienceFactory, T1, T2, T3> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, WebExperienceFactory, T2, T3, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3>(this CombinedResult<T1, WebExperienceFactory, T2, T3> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, WebExperienceFactory, T3, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3>(this CombinedResult<T1, T2, WebExperienceFactory, T3> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, WebExperienceFactory, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3>(this CombinedResult<T1, T2, T3, WebExperienceFactory> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T4, subFactoryAction));
    public static CombinedResult<WebExperienceFactory, T1, T2, T3, T4, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3, T4>(this CombinedResult<WebExperienceFactory, T1, T2, T3, T4> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T1, subFactoryAction));
    public static CombinedResult<T1, WebExperienceFactory, T2, T3, T4, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3, T4>(this CombinedResult<T1, WebExperienceFactory, T2, T3, T4> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T2, subFactoryAction));
    public static CombinedResult<T1, T2, WebExperienceFactory, T3, T4, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3, T4>(this CombinedResult<T1, T2, WebExperienceFactory, T3, T4> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T3, subFactoryAction));
    public static CombinedResult<T1, T2, T3, WebExperienceFactory, T4, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, WebExperienceFactory, T4> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T4, subFactoryAction));
    public static CombinedResult<T1, T2, T3, T4, WebExperienceFactory, InnerWebExperienceCustomizationConfigurationFactory> WithCustomizationConfiguration<T1, T2, T3, T4>(this CombinedResult<T1, T2, T3, T4, WebExperienceFactory> combinedResult, Action<Humidifier.QBusiness.WebExperienceTypes.CustomizationConfiguration> subFactoryAction = null) => new (combinedResult, combinedResult, combinedResult, combinedResult, combinedResult, WithCustomizationConfiguration(combinedResult.T5, subFactoryAction));
