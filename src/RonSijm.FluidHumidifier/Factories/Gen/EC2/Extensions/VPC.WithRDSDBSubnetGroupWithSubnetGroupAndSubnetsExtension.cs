...
using RonSijm.FluidHumidifier.Factories.RDS;
using RonSijm.FluidHumidifier.Factories.Custom.SubnetFactories;

namespace RonSijm.FluidHumidifier.Factories.EC2;

public static class RDSDBSubnetGroupWithSubnetsExtension
{
    public static DBSubnetGroupFactory WithRDSDBSubnetGroupAndSubnets(this VPCFactory factory, string subnetName, Action<SubnetFactoryConfig> config)
    {
