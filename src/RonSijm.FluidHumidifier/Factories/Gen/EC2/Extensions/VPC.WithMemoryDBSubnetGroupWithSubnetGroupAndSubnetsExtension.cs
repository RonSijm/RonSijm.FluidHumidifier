...
using RonSijm.FluidHumidifier.Factories.MemoryDB;
using RonSijm.FluidHumidifier.Factories.Custom.SubnetFactories;

namespace RonSijm.FluidHumidifier.Factories.EC2;

public static class MemoryDBSubnetGroupWithSubnetsExtension
{
    public static SubnetGroupFactory WithMemoryDBSubnetGroupAndSubnets(this VPCFactory factory, string subnetName, Action<SubnetFactoryConfig> config)
    {
        ...
        var dbSubnetGroupFactory = factory.CreateSubFactory(() => new SubnetGroupFactory($"{subnetName} Subnet Group", x =>
        {
            ...
            x.Description = "Default Subnet Group for MemoryDB";
        }));
