...
using RonSijm.FluidHumidifier.Factories.DocDB;
using RonSijm.FluidHumidifier.Factories.Custom.SubnetFactories;

namespace RonSijm.FluidHumidifier.Factories.EC2;

public static class DocDBDBSubnetGroupWithSubnetsExtension
{
    public static DBSubnetGroupFactory WithDocDBDBSubnetGroupAndSubnets(this VPCFactory factory, string subnetName, Action<SubnetFactoryConfig> config)
    {
